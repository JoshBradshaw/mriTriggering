...
// changeTimerInterval method added by Josh Bradshaw
// it probably isn't trustworthy at high frequecies, but that's not what
// millisecond polling is for anyway
...
public:
    ...
    void changeTimerInterval(int numTimer, int newInterval);
